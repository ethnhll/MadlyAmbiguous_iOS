...
urlPiece="arcs."
urlPart2="-of-99.gz"
localDir="/home/8/hillet/Documents/"
keywordsForGrep="(^\bate\b\s.+\b\swith\b/.+$)|(^\bspaghetti\b\s.+\b\swith\b/.+$)"
output="AteSpaghettiArcs"
...
function reduceFile {
	...
	zgrep -E ${keywordsForGrep} ${inputFile} | awk 'match($0, "[^,]*"){print substr($0,RSTART,RLENGTH-5)}' >> ${outputFile}	
}
